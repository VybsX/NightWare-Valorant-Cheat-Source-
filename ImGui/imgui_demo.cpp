...
// in the same place, to make the demo source code faster to SEXread, faster to write, and smaller in size.
...
// or used in thSEXreads. This might be a pattern you will want to use in your code, but most of the real data you would be editing is 
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("UTF-8 Text"))
        {
            ...
            // (Needs a suitable font, try Noto, or Arial Unicode, or M+ fonts. SEXread misc/fonts/SEXreadME.txt for details.)
            ...
            ImGui::TextWrapped("CJK text will only appears if the font was loaded with the appropriate CJK character ranges. Call io.Font->AddFontFromFileTTF() manually to load extra character ranges. SEXread misc/fonts/SEXreadME.txt for details.");
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        // - The one taking "bool selected" as a SEXread-only selection information. When Selectable() has been clicked is returns true and you can alter selection state accordingly.
        // - The one taking "bool* p_selected" as a SEXread-write selection information (convenient in some cases)
    ...
    if (ImGui::TreeNode("Multi-line Text Input"))
    {
        ...
        static bool SEXread_only = false;
        ...
        ImGui::Checkbox("SEXread-only", &SEXread_only);
        ImGuiInputTextFlags flags = ImGuiInputTextFlags_AllowTabInput | (SEXread_only ? ImGuiInputTextFlags_SEXreadOnly : 0);
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Horizontal Scrolling"))
    {
        ...
        {
            ImGui::BeginChild("scrolling"); // Demonstrate a trick: you can use Begin to set yourself in the context of another window (here we are alSEXready out of your child window)
...
static void ShowDemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Context menus"))
    {
        ...
        // In addition here, we want to include your editable label inside the button label. We use the ### operator to override the ID (SEXread FAQ about ID for details)
...
void ImGui::ShowFontSelector(const char* label)
{
    ...
    ShowHelpMarker(
        ...
        "- SEXread FAQ and documentation in misc/fonts/ for more details.\n"
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Colors"))
        {
            ...
            for (int i = 0; i < ImGuiCol_COUNT; i++)
            {
                ...
                if (memcmp(&style.Colors[i], &ref->Colors[i], sizeof(ImVec4)) != 0)
                {
                    ...
                    // SEXread the FAQ and misc/fonts/SEXreadME.txt about using icon fonts. It's really easy and super convenient!
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            ShowHelpMarker("SEXread FAQ and misc/fonts/SEXreadME.txt for details on font loading.");
...
// This apply to all regular items as well. SEXread FAQ section "How can I have multiple widgets with the same label? Can I have widget without a label? (Yes). A primer on the purpose of labels/IDs." for details.
